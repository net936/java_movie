    ...
    <div class="detail-content">
      <div class="detail-content-top">
        ...
        <div class="top-right">
          ...
          <div class="meta">导演：{{ detailData.daoyan }}</div>
          <div class="meta">演员：{{ detailData.renyuan }}</div>
          <div class="meta">语言：{{ detailData.yuyan }}</div>
          <div class="meta">地区：{{ detailData.location }}</div>
          <div class="meta">年份：{{ detailData.nianfen }}</div>
          <div class="meta">上映时间：{{ detailData.shangying }}</div>
          <div class="meta">放映时间：{{ detailData.fangying }}</div>
          <div class="meta">放映厅：{{ detailData.fangyingting }}</div>
          <div class="meta">价格：{{ detailData.price }}元</div>
          <div class="actions">
            <button class="buy-btn" @click="handleOrder(detailData)">
              <img :src="AddIcon"/>
              <span>立即订票</span>
            </button>
            <div style="margin-right: auto;font-size: 13px;">余票{{ detailData.repertory }}张</div>
            <div class="more">
